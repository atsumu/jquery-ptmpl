(function(a){function h(b){return b.replace(/\\/g,"\\\\").replace(/\r?\n\t*/g,"\\n").replace(/\'/g,"\\'").replace(/\"/g,'\\"')}function i(b){return Array.prototype.slice.call(b,0)}a.fn.ptmpl=function(b,e){a.isArray(b)||(b=[b]);var c=[],d=this[0];a.each(b,function(){c.push(a.ptmplGetCompiled(d,e)(e,this))});var f=document.createElement("div");f.innerHTML=c.join("");return a(a.ptmplMakeArray(f.childNodes))};a.ptmpl=function(b,e,c){return a.fn.ptmpl.apply([{id:null,innerHTML:b}],[e,c])};a.ptmplDefineTag=
function(b){a.each(b,function(b,c){a.ptmplTagTable[b]=c})};a.ptmplUndefineTag=function(b){a.each(b,function(b,c){delete a.ptmplTagTable[c]})};a.ptmplCompile=function(b,e,c){e||(e={});var d=[];e.noDebugInfo||d.push("try {");d.push("var _PTMPL_HTML = [];");d.push("with ($.ptmplScope(_PTMPL_ARG)) {");b.replace(/((?:a|[^a])*?)(?:\{\{((?:a|[^a])*?)\}\}|$)/g,function(b,c,f){c&&(b=a.ptmplTranslateHtmlToLiteral(c))&&d.push('_PTMPL_HTML.push("',b,'");');f&&(f.match(/([^\s\(]+)((?:a|[^a])*)/),a.ptmplTagTable[RegExp.$1](d,
RegExp.$2,e))});d.push("}");d.push('return _PTMPL_HTML.join("");');e.noDebugInfo||(d.push("} catch (e) {"),d.push('throw new Error("RuntimeError in '+a.ptmplEscapeStringLiteral(c.id?c.id:c.text.slice(0,100))+', "+e.message);'),d.push("}"));b=d.join("");e.debug&&console.log("code:",b);try{var f=new Function("_PTMPL_OPTION","_PTMPL_ARG",b)}catch(g){throw e.noDebugInfo||(g.message+=" in "+(c.id?c.id:c.text.slice(0,100))),g;}return f};a.ptmplGetCompiled=function(b,e){var c=b.id,d=b.innerHTML;if(c){if(c in
a.ptmplCache)return a.ptmplCache[c];if(d)return a.ptmplCache[c]=a.ptmplCompile(d,e,{id:"#"+c});d=document.getElementById(c).innerHTML;return a.ptmplCache[c]=a.ptmplCompile(d,e,{id:"#"+c})}return a.ptmplCompile(d,e,{text:d})};a.ptmplEscapeHtml=function(b){return(b?b.toString():""+b).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;").replace(/\'/g,"&#039;")};a.ptmplUnescapeHtml=function(b){return(b?b.toString():""+b).replace(/&#039;/g,"'").replace(/&quot;/g,'"').replace(/&gt;/g,
">").replace(/&lt;/g,"<").replace(/&amp;/g,"&")};a.ptmplEscapeUrl=encodeURIComponent;a.ptmplEscapeStringLiteral=h;a.ptmplTranslateHtmlToLiteral=h;a.ptmplMakeArray=a.makeArray||i;a.ptmplScope=function(b){function a(){}a.prototype=b;return new a};a.ptmplCache={};a.ptmplTagTable={};a.ptmplDefineTag({html:function(b,a){b.push("_PTMPL_HTML.push((",a,"));")},"=":function(b,a){b.push("_PTMPL_HTML.push($.ptmplEscapeHtml((",a,")));")},"~":function(b,a){b.push("_PTMPL_HTML.push($.ptmplEscapeHtml($.ptmplEscapeUrl((",
a,"))));")},$:function(b,a){b.push(a)},"!":function(){},"//":function(){}});var g;a.ptmplDefineTag({"if":function(b,a){b.push("if (",a,") {")},el:g=function(b,a){a?b.push("} else if (",a,") {"):b.push("} else {")},"else":g,"/if":function(b){b.push("}")}});a.ptmplDefineTag({tryif:function(b,a){b.push("if ((function () { try { return (",a,"); } catch (e) {} })()) {")},catchelse:g=function(b,a){a?b.push("} else if ((function () { try { return (",a,"); } catch (e) {} })()) {"):b.push("} else {")},"/tryif":function(b){b.push("}")}});
