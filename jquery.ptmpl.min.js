...
b.ptmplEscapeUrl=encodeURIComponent;b.ptmplEscapeStringLiteral=h;b.ptmplTranslateHtmlToLiteral=h;b.ptmplScope=function(a){function c(){}c.prototype=a;return new c};b.ptmplCache={};b.ptmplTagTable={};var j=Object.prototype.toString,i=function(a,c){a=Array.prototype.slice.call(a,0);return c?(c.push.apply(c,a),c):a};try{Array.prototype.slice.call(document.documentElement.childNodes,0)[0].nodeType}catch(k){i=function(a,c){var b=0,d=c||[];if("[object Array]"===j.call(a))Array.prototype.push.apply(d,a);
else if("number"===typeof a.length)for(var f=a.length;b<f;b++)d.push(a[b]);else for(;a[b];b++)d.push(a[b]);return d}}b.ptmplDefineTag({html:function(a,c){a.push("_PTMPL_HTML.push((",c,"));")},"=":function(a,c){a.push("_PTMPL_HTML.push($.ptmplEscapeHtml((",c,")));")},"~":function(a,c){a.push("_PTMPL_HTML.push($.ptmplEscapeUrl((",c,")));")},$:function(a,c){a.push(c)},"!":function(){},"//":function(){}});var g;b.ptmplDefineTag({"if":function(a,c){a.push("if (",c,") {")},el:g=function(a,c){c?a.push("} else if (",
c,") {"):a.push("} else {")},"else":g,"/if":function(a){a.push("}")}});b.ptmplDefineTag({tryif:function(a,c){a.push("if ((function () { try { return (",c,"); } catch (e) {} })()) {")},catchelse:g=function(a,c){c?a.push("} else if ((function () { try { return (",c,"); } catch (e) {} })()) {"):a.push("} else {")},"/tryif":function(a){a.push("}")}});b.ptmplDefineTag({"for":function(a,c){a.push("for (",c,") {")},"/for":function(a){a.push("}")}});b.ptmplDefineTag({each:function(a,c){if(null==c.match(/\s*\((?:\s*(\w+)\s*(?:,\s*(\w+)\s*))\)\s+((?:a|[^a])+)/))throw"ptmpl syntax error: near {{each"+
c+"}}";a.push("$.each((",RegExp.$3,"), function (",RegExp.$1,",",RegExp.$2,") {")},"/each":function(a){a.push("});")},"continue":function(a){a.push("return true;")},"break":function(a){a.push("return false;")}});b.ptmplDefineTag({tmpl:function(a,c){if(null==c.match(/\s*\(((?:a|[^a])*?)\)\s+((?:a|[^a])+)/))throw"ptmpl syntax error: near {{tmpl"+c+"}}";var b=RegExp.$1||"{}",d=RegExp.$2,f=d.match(/^\s*['"]#(.+?)["']\s*$/)&&RegExp.$1;f?a.push('_PTMPL_HTML.push($.ptmplGetCompiled({ id:"',f,'" }, _PTMPL_OPTION)(_PTMPL_OPTION, (',
b,")));"):a.push("_PTMPL_HTML.push($.ptmplGetCompiled($.find((",d,"))[0], _PTMPL_OPTION)(_PTMPL_OPTION, (",b,")));")}});b.ptmplStripPluginTranslateFunctionStack=[];b.ptmplDefineTag({strip:function(){var a=b.ptmplTranslateHtmlToLiteral;b.ptmplStripPluginTranslateFunctionStack.push(a);b.ptmplTranslateHtmlToLiteral=function(b){return a(b.replace(/\r?\n\t*/g,""))}},"/strip":function(){b.ptmplTranslateHtmlToLiteral=b.ptmplStripPluginTranslateFunctionStack.pop()}})})(window.jQuery||window.Zepto);
